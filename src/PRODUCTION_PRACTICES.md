...
| 37 | **Full unit test suite in CI** — all 203 tests run in CI with no external dependencies (LLM and DB are fully mocked) | ✅ | `.github/workflows/ci.yml` |
